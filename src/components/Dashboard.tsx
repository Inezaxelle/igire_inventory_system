    ...
    <div className="p-6 space-y-6 w-full">
      <div className="flex justify-between items-center">
        ...
        <div className="space-x-2">
          ...
          <Link href="/borrowing">
            <Button>
              <RotateCcw size={16} className="mr-2" /> Borrow/Return Item
            </Button>
          </Link>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <Card className="p-6">
          <h3 className="font-semibold text-gray-600 text-sm">Available Items</h3>
          <p className="text-3xl font-bold">{stats.availableItems}</p>
        </Card>
        <Card className="p-6">
          <h3 className="font-semibold text-gray-600 text-sm">Borrowed Items</h3>
          ...
          <ul className="space-y-2">
            {recentActivity.map((activity, index) => (
              <li key={index} className="text-sm">
                <span className="font-medium">{activity.action}</span> - {activity.item} by {activity.user}
              </li>
            ))}
          </ul>
        </Card>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <Card className="p-6">
          <h3 className="font-semibold text-lg mb-4">Item Status Distribution</h3>
